...
export class Backend implements backendInterface {
    ...
    async analyzeResume(arg0: string, arg1: string): Promise<ResumeAnalysis> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeResume(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getRecentAnalyses(arg0: string): Promise<Array<ResumeAnalysis>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentAnalyses(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
